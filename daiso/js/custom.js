$(function(){
    ...
    let swiper = new Swiper(".main_banner", {
      ...
      $(window).scroll(function(){
       ...
       let lineTop = $('.line_up').offset().top -400;   /* 라인업이 스크롤 될 위치를 lineTop에 저장 */
    ...
    $('.family p').eq(0).click(function(){
        ...
        $(this).find('i').toggleClass("fa-solid fa-angle-down").toggleClass("fa-solid fa-angle-up")
    });
